...
#draw-network((
  ...
  branch(spread: 13, lead: 2.5, branches: (
    (input(image: "default", shape: (3, 640, 640), label: "RGB", channels: (3, 640), name: "rgb", label-orient: "horizontal"),),
    (input(image: image("bird-ir.jpg"), shape: (3, 640, 640), label: "IR ×3", channels: (3, 640), name: "ir", label-orient: "horizontal"),),
  )),
  concat(shape: (6, 640, 640), name: "fcat", label: "concat", offset: auto, label-dx: 0.7, ..lbl),
  custom(shape: (3, 640, 640), label: "1×1 mix", channels: (3, 640),
  ...
  conv(shape: (64, 80, 80), label: "P3/8", channels: (64, 80), name: "p3d", offset: auto, ..lbl),
  convres(shape: (128, 80, 80), label: "C3k2", channels: (128, 80), name: "p3", offset: auto, ..lbl),
  ...
  group(from: "rgb", to: "mix", label: "early fusion"),
  ...
  group(from: "rgb", to: "mix", label: "Fusion", offset: 2.5),
